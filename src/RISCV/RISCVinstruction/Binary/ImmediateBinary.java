...
public class ImmediateBinary extends RISCVInstruction {
    ...
    public SCategory op;
    public ImmediateBinary(RISCVRegister rs, RISCVImmediate imm, SCategory op, RISCVRegister rd, RISCVBasicBlock RISCVBasicBlock) {
        this.rs = rs;
        this.imm = imm;
        this.op = op;
        this.rd = rd;
    ...
    public String toString() {
        return op + "i " + rd + ", " + rs + ", " + imm.getValue();
    }
    @Override
