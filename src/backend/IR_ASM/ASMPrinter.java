...
public class ASMPrinter {
    ...
    void PrintGlobalRegister(RISCVGlobalRegister gReg) {
        out.println("\t.type\t" + gReg.identifier + ",@object");
        out.println("\t.section\t.data");
        out.println("\t.globl\t" + gReg.identifier);
        out.println("\t.p2align\t2");
        out.println(gReg.identifier + ":");
        out.println("\t.zero\t" + gReg.width);
        out.println("\t.size\t" + gReg.identifier + ", " + gReg.width + "\n");
    }
    ...
    void PrintConstString(RISCVGlobalRegister gReg, String s) {
        ...
        out.println(gReg.identifier + ":");
        out.println("\t.asciz\t\"" + s + "\"");
        out.println("\t.size\t" + gReg.identifier + ", " + (s.length() + 1) + "\n");
    }
