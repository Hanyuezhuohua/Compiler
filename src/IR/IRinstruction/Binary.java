...
public class Binary extends IRInstruction{
    ...
    public boolean merge() {
        if(next instanceof Binary){
            if(op == IRBinaryOpType.add && ((Binary) next).getOp() == IRBinaryOpType.add && op2 instanceof IRConstInt && ((Binary) next).op2 instanceof IRConstInt && result == ((Binary) next).op1 && ((IRConstInt) op2).getValue() == 1){
